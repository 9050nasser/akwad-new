...
export default async function TotalDelaysReportPage({
  ...
  return (
    <PageFrame
      exportFileSlug="total-delays"
      title="تقرير إجمالي التأخير"
      subtitle="مجموع شفتات التأخير ودقائق التأخير لكل موظف ضمن الفترة (دوام ثابت + نقص دوام مفتوح)."
    >
      ...
      <p className="mt-4 text-sm text-slate-700">
        إجمالي شفتات متأخرة: <span className="font-semibold">{totalShifts}</span> — إجمالي دقائق التأخير:{" "}
