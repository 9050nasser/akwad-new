...
export default async function AbsenceReportPage({
  ...
  return (
    <PageFrame
      exportFileSlug="absence"
      title="تقرير الغياب"
      subtitle="عدد أيام بلا دخول مرحّل خلال الفترة (بدون استثناء العطل في هذا الإصدار)."
    >
      ...
      <p className="mt-4 text-xs text-slate-500">عدد أيام الفترة: {days}</p>
