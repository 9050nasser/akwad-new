...
import { createNationality, deleteNationality } from "@/app/actions/catalog";
...
export default async function NationalitiesPage({
  ...
  return (
    <PageFrame title="الجنسيات" subtitle="قائمة مرجعية للجنسيات المرتبطة بالموظفين.">
      <FlashBanner notice={flash.notice} error={flash.error} />
      <form action={createNationality} className="grid gap-4 md:grid-cols-3">
        <div className="md:col-span-2">
          <Label htmlFor="name">اسم الجنسية</Label>
              ...
              <tr key={r.id} className="hover:bg-slate-50/80">
                ...
                <td className="px-4 py-3">
                  <ConfirmServerActionForm
                    ...
                    confirmMessage="حذف هذه الجنسية؟"
                    className="inline"
                  >
